				...
				<form id="joinForm" name="joinForm" method="post" action="/join">
					<div class="form-group">
						<br><label for="id">id:</label> <input type="text"
							class="form-control" id="id" placeholder=${mem.id }
							name="id" readonly >
					</div>
					<div class="form-group">
						<label for="name">이름:</label> <input type="text"
							class="form-control" id="memName" placeholder=${mem.name }
					...
					<div class="form-group">
						<label for="pwd">Password:</label> <input type="password"
							...
							placeholder=${mem.name } name="pwd" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<div class="form-group">
						<label for="pwd">Password 확인:</label> <input type="password"
							...
							placeholder=${mem.pwd } name="pwd2" required>
						<div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
					</div>
					...
					<div class="form-group">
						<div class="form-group">
							<label for="gender">성별:</label> <input class="form-control"
								id="gender" name="gender"  placeholder=${mem.gender }
